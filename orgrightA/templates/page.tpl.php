...
<!-- specify newportal outer structure -->
<div id="page-outer">
<div id="page-inner">
<!-- end of newportal outer structure -->
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
     ...
     <div id="header-right">
      <?php if ($loggedin): ?>
        <div id="loggedin"><?php print $loggedin; ?></div><!-- /#loggedin -->
      <?php endif; ?>
	  ...
	  <?php 
	print toplevel_menu_output(menu_tree_all_data('orgRight'),
            array(
              'id' => 'main-menu',
...
<!-- finish newportal outer structure -->
</div><!-- #page-inner -->
</div><!-- #page-outer -->
<!-- end of newportal outer structure -->
<?php print $closure; ?>
