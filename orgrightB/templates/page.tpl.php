...
<!-- specify orgrightB outer structure -->
<div id="page-outer">
  <div id="page-inner">
    <!-- end of orgrightB outer structure -->

    <?php if ($primary_links): ?>
    <div id="skip-link"><a
      href="#main-menu"><?php print t('Jump to Navigation'); ?></a></div>
    <?php endif; ?>
      ...
      <div id="page">
        ...
        <div id="header">
          <div class="section clearfix">
            ...
            <div id="header-right">
              <?php if ($loggedin): ?>
              <div id="loggedin"><?php print $loggedin; ?></div>
              <!-- /#loggedin -->
              <?php endif; ?>
          ...
          <div id="navigation">
            ...
            <div class="section clearfix">
              ...
              <?php
              print orgrightB_toplevel_menu_output(menu_tree_all_data('orgRight'),
                array(
                  'id' => 'main-menu',
          ...
          <div id="main" class="clearfix">
            <div id="content" class="column">
              <div class="section">
                ...
                <?php if ($breadcrumb || $title || $tabs || $messages): ?>
                ...
                <div id="content-main" class="region region-content">
    ...
    <!-- finish orgrightB outer structure -->
  </div>
  <!-- #page-inner -->
</div>
<!-- #page-outer -->
